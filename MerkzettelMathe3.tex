...
\begin{document}
    ...
    \section{Stochastik}
	    ...
	    \subsection{Verschiedene Verteilungen}
		   \subsubsection{Gleichverteilung}	
	    	...
	    	\end{align*}
	    	\text{Für $\Phi$ siehe Standardnormalverteilungstab.}\\
	...
	\section{Numerik}
		...
		\subsection{LU-Zerlegung}
			...
			%Sei $A \in \mathbb{R}^{m\cdot n}$. Wir initialisieren drei Matrizen: $P = L = I_m$ und $A = U$.\\
		...
		\subsection{Cholesky-Zerlegung}
			Eine symmetrische Matrix ist die Voraussetzung für eine Cholesky-Zerlegung. Außerdem muss die Determinante jeder Teilmatrix > 0 sein.
